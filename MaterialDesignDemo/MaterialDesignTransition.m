...
@interface MaterialDesignTransition ()
@property (strong, nonatomic) id<UIViewControllerContextTransitioning>transitionContext;
@end

@implementation MaterialDesignTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    UIBezierPath *startCircle = [UIBezierPath bezierPathWithOvalInRect:fromVC.button.frame];
    UIBezierPath *finalCircle = [UIBezierPath bezierPathWithOvalInRect:CGRectInset(fromVC.button.frame, -radius, -radius)];
